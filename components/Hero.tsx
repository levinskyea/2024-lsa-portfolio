      ...
      <div className="flex justify-center relative my-20 z-10">
        <div className="max-w-[89vw] md:m-w-2xl lg:max-w-[60vw] flex flex-col items-center justify-center">
          <div className="flex gap-3">
            <OutlineButton title="Web Developer" />
            <OutlineButton title="Software QA Engineer" />
            <OutlineButton title="UI / UX Designer" />
          </div>

          <TextGenerateEffect
            className="text-center text-[40px] md:text-5xl lg:text-6xl"
            words="LEVIN SKYE ALIGWAY"
          />
          ...
          <a href="#about">
            <MagicButton title="Download CV" icon="" position="" />
          </a>
        </div>
      </div>
    </div>
